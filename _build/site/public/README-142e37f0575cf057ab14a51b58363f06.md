...
This package is the first publicly available open‑source implementation of these tools in the Python ecosystem, relying only on NumPy and LinearAlgebra.jl for minimal and efficient dependencies.