...
flowchart TD
    ...
    U[Inputs u_t]:::step
    E[Iterated integrals E_N]:::step
    G[Vector fields g_i]:::step
    L[Lie derivatives L_h]:::step
    F[Chen-Fliess series F_N]:::step
    O[Output h_t]:::step
...
see the [examples](content/Examples.md) of the documentation.